...
public class PluginMaterials {
    ...
    public static Item.ToolMaterial custom_dark_metal = EnumHelper.addToolMaterial("UNIQUE_DARK_METAL", EnumToolMaterials.DARK_METAL.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.DARK_METAL.getEfficiencyOnProperMaterial(), 7, 0);
    public static Item.ToolMaterial custom_blue_steel = EnumHelper.addToolMaterial("UNIQUE_BLUE_STEEL", EnumToolMaterials.BLUE_STEEL.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.BLUE_STEEL.getEfficiencyOnProperMaterial(), 7, 0);
    public static Item.ToolMaterial custom_jungle = EnumHelper.addToolMaterial("UNIQUE_JUNGLE", EnumToolMaterials.JUNGLE.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.JUNGLE.getEfficiencyOnProperMaterial(), 7, 0);
    public static Item.ToolMaterial custom_glass = EnumHelper.addToolMaterial("UNIQUE_GLASS", EnumToolMaterials.GLASS.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.GLASS.getEfficiencyOnProperMaterial(), 7, 0);
    public static Item.ToolMaterial custom_imperial_gold = EnumHelper.addToolMaterial("UNIQUE_IMPERIAL_GOLD", EnumToolMaterials.IMPERIAL_GOLD.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.IMPERIAL_GOLD.getEfficiencyOnProperMaterial(), 7, 0);
    public static Item.ToolMaterial custom_aqua = EnumHelper.addToolMaterial("UNIQUE_AQUA", EnumToolMaterials.AQUA.getHarvestLevel(), EnumToolMaterials.UNIQUEMATERIAL.getMaxUses(), EnumToolMaterials.AQUA.getEfficiencyOnProperMaterial(), 7, 0);
