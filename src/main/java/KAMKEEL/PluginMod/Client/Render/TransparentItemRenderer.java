...
public class TransparentItemRenderer implements IItemRenderer {
    ...
    public static final ResourceLocation enchant = new ResourceLocation("textures/misc/enchanted_item_glint.png");
	public TextureManager texturemanager;

	public TransparentItemRenderer(GameSettings gameSettings, TextureManager textureManager) {
    ...
    public void customRender(ItemStack par2ItemStack) {
        if (!(par2ItemStack.getItem() instanceof ItemCustomTransparent))
            return;
        GL11.glTranslatef(0.9375F, 0.0625F, 0.0F);
        GL11.glRotatef(-315.0F, 0.0F, 0.0F, 1.0F);

        ((ItemCustomTransparent) par2ItemStack.getItem()).renderSpecial();
	...
	public void renderItemEquipped(IIcon iicon, ItemStack par2ItemStack) {
        ...
        // Only Run if Custom Size
        customRenderPart2(par2ItemStack);
